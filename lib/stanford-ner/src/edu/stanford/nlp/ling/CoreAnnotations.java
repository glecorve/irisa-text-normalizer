...
public class CoreAnnotations {
  ...
  // Per token annotation indicating whether the numeric phrase the token is part of
  ...
  // Per token annotation indicating the numeric value of the phrase the token is part of
  // (twenty first => 21 21 )
